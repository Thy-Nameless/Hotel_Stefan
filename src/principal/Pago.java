...
public class Pago extends JFrame {
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (matcher.matches()) {
				...
				JOptionPane.showMessageDialog(rootPane,
						"El n�mero de tarjeta solo puede contener d�gitos en bloques de 4 debidamente espaciados (0000 0000 0000 0000)");
	...
	private class TextFieldNumKeyListener extends KeyAdapter {
		@Override
		/**
		 * Este m�todo permite la comprobaci�n de s� el car�cter ingresado es un n�mero,
		 * excede el rango de la tarjeta, o es una letra o caracter especial
		 */
