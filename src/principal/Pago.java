...
public class Pago extends JFrame {
	...
	private class BtnNewButtonMouseListener extends MouseAdapter {
		@Override
		/** Comprobaciones generales de longitud de c�digo de tarjeta, cvc y su validad */
		public void mouseClicked(MouseEvent e) {
			...
			if (matcher.matches()) {
				...
				if (matcher.matches()) {
					JOptionPane.showMessageDialog(rootPane, "Pago realizado con �xito");
					new ReservasCliente(usuarioReserva,reservaRealizada).setVisible(true);
					dispose();
				} else {
					JOptionPane.showMessageDialog(rootPane, "El c�digo CVC debe estar formado por 3 d�gitos.");
					textFieldCVV.setText("");
				}
			} else {
				JOptionPane.showMessageDialog(rootPane, "El n�mero de tarjeta solo puede contener d�gitos en bloques de 4 debidamente espaciados (0000 0000 0000 0000)");
	...
	private class TextFieldNumKeyListener extends KeyAdapter {
		@Override
		/** Este m�todo permite la comprobaci�n de s� el car�cter ingresado es un n�mero, excede el rango de la tarjeta, o es una letra o caracter especial */
	...
	/** Realizaci�n de la comprobaci�n del c�digo CVC */
	...
	/** Inicializaci�n de todos los apartados del programa */
